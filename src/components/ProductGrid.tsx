...
const ProductGrid = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8" id="products">
      <h2 className="text-3xl font-bold text-center mb-8">Our Cake Collection</h2>
      ...
      {filteredProducts.length === 0 ? (
        <div className="text-center py-8">
          <p className="text-gray-600">No cakes found. Try a different search term or category.</p>
        </div>
      ) : (
